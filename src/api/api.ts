...
import type { GoodsData, ProductsResponse,RankingFilterOption, RankingResponse, ThemeData, ThemesResponse } from '@/types';
...
export const fetchTheme = async (themeKey: string): Promise<ThemeData | undefined> => {
